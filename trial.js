...
function openHelp() {
  trialModal('使用说明 · 试用周', `
    <h3>这是什么？</h3>
    <p>华跃内部的<strong>全球保温建材资讯监控平台</strong>。资讯来自真实行业信源（Global Insulation、中东建筑媒体、Google News 等），每天早上 08:00 自动抓取并由 AI 翻译、分类、评分。本周目标是验证页面结构是否好用，请放心随便点。</p>

    <h3>一屏怎么用</h3>
    <ul>
      <li><strong>顶部分类签</strong>：第一个"⭐精选"是 AI 从全部资讯里挑出的重点（默认展示）；想看全量点"全部"，想看某一类点对应的签。</li>
      <li><strong>四张统计卡都能点</strong>：点"高影响"只看需要关注的，点"总资讯"一键清除所有筛选。</li>
      <li><strong>左侧选国家</strong>：比如点"沙特"，只看沙特的动态，可多选。</li>
      <li><strong>资讯按日期分组</strong>：往下刷就是往回翻日子，每天的条数和政策数在日期旁边。</li>
      <li><strong>右侧政策预警</strong>：各国标准/认证的最新变动，点击直达原文。</li>
    </ul>

    <h3>几个值得试的操作</h3>
    <ul>
      <li>每条资讯下的"为什么值得看"是 AI 给出的业务影响判断</li>
      <li>点"&#9998; 选题建议"展开内容创作角度（做内容的同事重点看）</li>
      <li>搜索框输入"沙特"或"岩棉"试试</li>
